...
<span style="color:red">This is an unfinished port of the package's "old" Sweave/PDF vignette into Rmarkdown/HTML. There are still bugs in here, like unevaluated LaTeX markup, unmapped cross-references, awkward figure dimensions. Please bear with me. In doubt, please consult the [existing PDF vignette](0-vsn.pdf).</span>
