...
%
\begin{figure*}
\includegraphics[width=0.49\textwidth]{vsn-nkid-sdmean1}  
\includegraphics[width=0.49\textwidth]{vsn-nkid-sdmean2}  
...
@
\incfig{vsn-nkid-histM}{0.65\textwidth}{Histogram of generalised 
log-ratios \Robject{M} for the kidney example data.}

\incfig{vsn-lym-sdmean}{0.65\textwidth}{Standard deviation 
versus rank of the mean for the lymphoma example data}

\incfig{vsn-lym-M}{0.65\textwidth}{$M$-$A$-plot 
...
%--------------------------------------------------
\begin{smallfigure}
\includegraphics[width=\textwidth]{vsn-figstrata}  
...
%---------------------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{vsn-figmiss}  
...
% 
\incfig{vsn-figref}{0.65\textwidth}{Scatterplot of normalised 
...
%---------------------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{vsn-nkid-calib}  
...
\begin{figure*}
\includegraphics[width=\textwidth]{vsn-qvsn}  
...
%
\begin{smallfigure}
\includegraphics[width=\textwidth]{vsn-figshrink}
...
\begin{smallfigure}
\includegraphics[width=\textwidth]{vsn-figgraph}
...
%---------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{vsn-lymbox}  
...
@ 
%
\incfig{vsn-lymquscp}{0.65\textwidth}{$M$-$A$-plot of the data from
