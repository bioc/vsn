...
%
\begin{figure*}
\includegraphics{A-vsn-nkid-scp}  
\caption{\label{A-vsn-nkid-scp}%
...
%
\begin{figure*}
\includegraphics[width=0.49\textwidth]{A-vsn-nkid-sdmean1}  
\includegraphics[width=0.49\textwidth]{A-vsn-nkid-sdmean2}  
\caption{\label{A-vsn-nkid-sdmean}%
...
\figphrase{A-vsn-nkid-scp} you can see the scatterplot of the
...
The two plots are shown in \figphrase{A-vsn-nkid-sdmean}.  The red
...
\figphrase{A-vsn-nkid-histM}.
%
<<nkid-histM,echo=FALSE,fig=TRUE,results=hide>>=
hist(M, breaks=33, col="#d95f0e")
@
\incfig{A-vsn-nkid-histM}{0.65\textwidth}{Histogram of generalised 
log-ratios \Robject{M} for the kidney example data.}

\incfig{A-vsn-lym-sdmean}{0.65\textwidth}{Standard deviation 
versus rank of the mean for the lymphoma example data}

\incfig{A-vsn-lym-M}{0.65\textwidth}{$M$-$A$-plot 
...
Again, \figphrase{A-vsn-lym-sdmean} helps to visually verify that the
...
@
%
\figphrase{A-vsn-lym-M} shows the resulting $M$-$A$-plot~\cite{Dudoit578}
...
@ 
%
The scatterplots produced by the code below are compared in \figphrase{A-vsn-affy}.
%
<<figaffy1,echo=FALSE>>=
...
\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-affy}  
\caption{\label{A-vsn-affy}%
...
%
\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-figlimma}  
\caption{\label{A-vsn-figlimma}%
...
@ 
%
\figphrase{A-vsn-figlimma} shows the resulting $p$-values and
...
%--------------------------------------------------
\begin{smallfigure}
\includegraphics[width=\textwidth]{A-vsn-figstrata}  
\caption{\label{A-vsn-figstrata}%
...
using the two models, is shown in \figphrase{A-vsn-figstrata}.
%
...
%---------------------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-figmiss}  
\caption{\label{A-vsn-figmiss}%
...
% 
\incfig{A-vsn-figref}{0.65\textwidth}{Scatterplot of normalised 
...
@
% 
and compare the resulting values in the scatterplot shown in \figphrase{A-vsn-figref}:
...
%---------------------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-nkid-calib}  
\caption{\label{A-vsn-nkid-calib}%
...
The result is shown in \figphrase{A-vsn-nkid-calib}.
...
dev.off()
@ 
The result is shown in \figphrase{A-vsn-qvsn}.

\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-qvsn}  
\caption{\label{A-vsn-qvsn}%
...
%
\begin{smallfigure}
\includegraphics[width=\textwidth]{A-vsn-figshrink}
\caption{\label{A-vsn-figshrink}The shrinkage property of the 
...
\begin{smallfigure}
\includegraphics[width=\textwidth]{A-vsn-figgraph}
\caption{\label{A-vsn-figgraph}Graphs of the functions $y=\log_2(x)$,
...
An illustration is shown in \figphrase{A-vsn-figshrink}.  Data were
...
%---------------------------------------------------------
\begin{figure*}
\includegraphics[width=\textwidth]{A-vsn-lymbox}  
...
@ 
%
\incfig{A-vsn-lymquscp}{0.65\textwidth}{$M$-$A$-plot of the data from
...
(\figphrase{A-vsn-lymquscp}), we see that these features not only have
