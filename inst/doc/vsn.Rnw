...
\documentclass[11pt,widemargin]{article}
...
@
\myincfig{vsn-nkid-calib4}{0.9\textwidth}{Scatterplots for badly biased 
...
@
\myincfig{vsn-sagmb-show}{0.9\textwidth}{Estimation error for the transformation:
...
estimation error should decrease as $n^{-1/2}$.
}
