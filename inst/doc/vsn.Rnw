...
\usepackage[margin=1.75cm,noheadfoot]{geometry}
...
\myincfig{vsn-fdr3}{0.5\textwidth}{False Discovery Rate}
<<fdr1,results=hide>>=
library(multtest)
...
%------------------------------------------------------------------------
\section{Verifying and assessing the performance of vsn with simulated
data} \label{sagmb}
%------------------------------------------------------------------------
