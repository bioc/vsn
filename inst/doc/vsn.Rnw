...
% 
\myincfig{vsn-figref}{0.45\textwidth}{Scatterplot of normalized 
intensities after normalization by reference ($x$-axis, \Robject{f8})
and joint normalization ($y$-axis, \Robject{fall}).}
%
...
@
% 
and compare the resulting values in the scatterplot Figure~\ref{figref}.
%
