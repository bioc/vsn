...
\begin{document}
%------------------------------------------------------------------------
\title{Assessing the accuracy of vsn with simulated data}
%------------------------------------------------------------------------
...
<<figmiss1>>=
makeFig("figmiss", 2, 1, {
miss = seq(0, 0.5, length=6)
res1 = sim(miss=miss, d=8)
res2 = sim(miss=miss, d=2)
myPlot2(miss, list("fraction NA (d=8)"=res1, "b) fraction NA (d=2)"=res2))
})
@ 
%
\begin{figure}[tbp]
